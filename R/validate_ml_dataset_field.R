is_valid_ml_required_field <- function(dataset_name, dataset_contents, field) {
...
is_valid_ml_options_field <- function(dataset_name, dataset_contents, field) {
...
is_valid_ml_numeric_field <- function(dataset_name, dataset_contents, field) {
...
is_valid_ml_r_corr <- function(dataset_name, dataset_contents, field){
  field_contents <- dataset_contents[[field$field]]
...
is_valid_ml_length <- function(dataset_name, dataset_contents, field, length_limit){
  field_contents <- dataset_contents[[field$field]]
...
validate_ml_field <- function(dataset_name, dataset_contents, field) {
  if (field$required) {
    if (!is_valid_ml_required_field(dataset_name, dataset_contents, field)) {
      return(FALSE)
    }
    ...
    if (field$field == "short_cite") {
      ...
      if(!is_valid_ml_length(dataset_name, dataset_contents, field, 60)) {
        return(FALSE)
      }
    }
    if (field$type == "options") {
      if (!is_valid_ml_options_field(dataset_name, dataset_contents, field)) {
        return(FALSE)
      }
    } else if (field$type == "numeric") {
      if (!is_valid_ml_numeric_field(dataset_name, dataset_contents, field)) {
        return(FALSE)
      }
      if (field$field == "r" || field$field == "corr"){
        if(!is_valid_ml_r_corr(dataset_name, dataset_contents, field)){
          return(FALSE)
        }
      }
